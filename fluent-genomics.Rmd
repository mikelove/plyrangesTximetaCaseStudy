...
subtitle: "Overlapping differential expression and differential chromatin accessibility"
...
The data is fairly large. For this workflow we need the files:
...
* We specified a fixed window for computing overlaps. How could we
